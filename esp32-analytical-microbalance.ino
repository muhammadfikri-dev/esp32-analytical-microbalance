/**
 * =========================================================================================
 * Project     : ESP32 Precision Analytical Balance Scale (0.1mg Resolution)
 * Platform    : ESP32 (Dual-Core Xtensa LX6 / FreeRTOS)
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Laboratory microgram scale utilizing electromagnetic force compensation / 24-bit ADC, draft shield stepper door actuation, vibration digital filtering, and USB-HID output.
 * =========================================================================================
 */
...
void TaskTelemetryBroadcaster(void *pvParameters) {
    ...
    for (;;) {
        if (xSemaphoreTake(g_telemetryMutex, pdMS_TO_TICKS(20)) == pdTRUE) {
            ...
            doc["system"] = "esp32-analytical-microbalance";
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" ESP32 Precision Analytical Balance Scale (0.1mg Resolution)"));
