# ⚡ ESP32 Precision Analytical Balance Scale (0.1mg Resolution)
...
Laboratory microgram scale utilizing electromagnetic force compensation / 24-bit ADC, draft shield stepper door actuation, vibration digital filtering, and USB-HID output.
...
3. Pastikan dependensi pustaka terpasang:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-analytical-microbalance.ino`](./esp32-analytical-microbalance.ino).
